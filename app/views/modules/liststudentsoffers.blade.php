    ...
    <div class="block">
      <div class="row">
        ...
        <div class="col-md-2 col-sm-2text-right">
          <a class="btn btn-block btn-default btn-block-xs" href="{{ URL::to("/classes/offers?t=".Crypt::encrypt($info[0]->idClass)) }}">Voltar</a>
        </div>
      </div>
    </div>
                ...
                <tr id='{{ Crypt::encrypt($student->id) }}' class='list-student'>
                  ...
                  <td>
                    <div class="col-xs-10 text-right">
                      @if($student->status == "M")
                        <label class="label label-success"><i class="fa fa-check"></i> Matriculado</label>
                      @elseif($student->status == "D")
                        <label class="label label-danger"><i class="fa fa-thumbs-down"></i> Desistente</label>
                      @elseif($student->status == "T")
                        <label class="label label-info"><i class="fa fa-exchange"></i> Transferido</label>
                      @endif
                    </div>
