      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            {{ Form::text("name", null, ["class" => "form-control", "placeholder" => "Digite aqui o nome do curso"]) }}
          </div>
          <div class="form-group">
            ...
            {{ Form::text("type", null, ["class" => "form-control", "placeholder" => "Digite aqui o tipo de ensino"]) }}
          </div>
          <div class="form-group">
            ...
            {{ Form::text("modality", null, ["class" => "form-control", "placeholder" => "Digite aqui a modalidade"]) }}
          </div>
          <div class="form-group">
            ...
            {{ Form::text("absentPercent", "25", ["class" => "form-control error"]) }}
          </div>
          <div class="form-group">
            ...
            {{ Form::text("average", "7.0", ["class" => "form-control grade"]) }}
          </div>
          <div class="form-group">
            ...
            {{ Form::text("averageFinal", "5.0", ["class" => "form-control grade"]) }}
          </div>
          <div class="form-group">
            ...
            {{ Form::file("curricularProfile", ["class" => "form-control"]) }}
          </div>
        </div>
