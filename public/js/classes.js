$(function () {
	...
	$("#period").change(function () {
		...
		$.post('classes/countDisciplines', {'period': $(this).val()}, function (data) {
			if (data.status) {
	...
	$("#formReceiveClass").submit(function (e) {
		...
		$(e.target).find('fieldset').each(function (i, field) {
			...
			if (classe.length == 2) {
				fields.push({
					'classe_id': classe[0].value,
					'with_offers': classe[1].value
				});
			}
