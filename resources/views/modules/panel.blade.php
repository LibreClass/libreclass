        ...
        <div class="col-md-12">
          <h3 class="pull-left text-blue">
            <b>
              ...
              @endif
              @if($unit_current->offer->grouping == 'S')
                <small class="text-muted">({{ $unit_current->offer->master->discipline->name }})</small>
              @endif
            </b>
          </h3>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="list-inline">
            ...
            <a href='{{ URL::to("/avaliable/finalunit/" . encrypt($unit_current->id)) . "?edit=e" }}' class="btn btn-default">Recuperação da Unidade</a>
            <a target="_blank" href='{{ URL::to("/lectures/units/report-unit/" . encrypt($unit_current->id)) }}' class="btn btn-default"><i class="fa fa-print"></i> Gerar Relatório</a>
        ...
        <div id="block-lesson" class="panel panel-default">
          <div class="panel-body">
            <div class="row">
              ...
              <div class="col-md-6 col-xs-6">
								@if($unit_current->offer->grouping == 'M')
									<a id="new-lesson-group" class="btn btn-default pull-right" href='{{"/lessons/new?unit=" . encrypt($unit_current->id)}}' offer-id="{{ encrypt($unit_current->offer->id) }}"><i class="fa fa-plus"></i> Nova aula</a>
								@else
									<a id="new-block" class="btn btn-default pull-right" href='{{"/lessons/new?unit=" . encrypt($unit_current->id)}}' offer-id="{{ encrypt($unit_current->offer->id) }}"><i class="fa fa-plus"></i> Nova aula</a>
								@endif
              </div>
            </div>
          </div>
            ...
            <div class="panel-heading">
              <div class="row">
                ...
                <div class="col-xs-6">
                  <i class="pull-right fa fa-gears icon-default click" data-toggle="dropdown" aria-expanded="false"></i>
                  <ul class="dropdown-menu dropdown-menu-right" role="menu">
                    <li><a href='{{ URL::to("/lessons?l=" . encrypt($lesson->id)) }}'><i class="fa fa-edit text-blue"></i> Editar</a></li>
              ...
              <div class="row">
                <div class="col-md-12">
                  	...
                  	<p class="text-info"><i class="fa fa-calendar"></i> {{ date("d/m/Y", strtotime($lesson->date)) }}</p>
									@endif
                  <p class="text-blue">
                    <a href='{{ URL::to("/lessons?l=" . encrypt($lesson->id)) }}'>{{ $lesson->title }}</a>
                  </p>
        ...
        <div class="panel panel-default">
          <div class="panel-body">
            <div class="row">
              ...
              <div class="col-md-6 col-xs-6">
                <a id="new-block" href='{{ URL::to("/avaliable/new?u=" . encrypt($unit_current->id)) }}' class="btn btn-default pull-right"><i class="fa fa-plus"></i> Nova avaliação</a>
              </div>
                ...
                <div class="panel-heading">
                  <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                      ...
                      <i class="pull-right fa fa-gears icon-default click" data-toggle="dropdown" aria-expanded="false"></i>
                      <ul class="dropdown-menu dropdown-menu-right" role="menu">
                        <li><a href='{{ URL::to("/avaliable/finalunit/" . encrypt($unit_current->id)) . "?edit=e" }}'><i class="fa fa-edit text-blue"></i> Editar</a></li>

                      </ul>

                      <!--<i class="pull-right fa fa-search icon-default click"></i>-->
                      <!--<a href='{{-- URL::to("/avaliable/finalunit/" . encrypt($unit_current->id)) --}}'><i class="pull-right fa fa-file-text-o icon-default click"></i></a>-->
                    </div>
                  </div>
                </div>
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <p class="text-info">
                        <a href='{{ URL::to("/avaliable/finalunit/" . encrypt($unit_current->id)) }}'>
                        {{ $recovery->title }}
                        </a>
                      </p>
            ...
            <div class="panel-heading">
              <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                  <i class="pull-right fa fa-gears icon-default click" data-toggle="dropdown" aria-expanded="false"></i>
                  <ul class="dropdown-menu dropdown-menu-right" role="menu">
                    <li><a href='{{ URL::to("/avaliable?e=" . encrypt($exam->id)) }}'><i class="fa fa-edit text-blue"></i> Editar</a></li>
                    <li><a href="{{ URL::to("/avaliable/delete") }}" class="trash click"><i class="fa fa-trash text-danger"></i> Deletar</a></li>
                  </ul>
                  <!--<i class="pull-right fa fa-search icon-default click"></i>-->
                  <!--<a href='{{-- URL::to("/avaliable/liststudentsexam/" . encrypt($exam->id)) --}}'><i class="pull-right fa fa-file-text-o icon-default click"></i></a>-->
                </div>
              </div>
            </div>
            <div class="panel-body">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <p class="text-info">
                    <a href='{{ URL::to("/avaliable/liststudentsexam/" . encrypt($exam->id)) }}'>
                    {{ $exam->title }}
                    </a>
                  </p>
                  <p>{{ $exam->comments }}</p>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="createLessonGroup">
				<input type="text" name="group_id" value="{{ encrypt($unit_current->offer->id) }}" hidden>
				<input type="text" name="unit" value="{{ encrypt($unit_current->id) }}" hidden>
				...
				<div class="modal-body">
					...
					<div class="form-inline">
						<div class="form-group">
							{{ Form::selectRange("date-day", 1, 31, (int) date('d'),["class" => "form-control"]) }}
							{{ Form::selectRange("date-month", 1, 12, (int) date("m"), ["class" => "form-control"]) }}
