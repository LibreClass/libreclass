    ...
    <div id="block" class="block">
      ...
      <div class="row">
        ...
        <div class="col-md-2 col-sm-2 text-right">
          <a href="{{ URL::to("/lectures/units?u=" . encrypt($lesson->unit_id)) }}" class="btn btn-default btn-block">Voltar</a>
        </div>

      </div>
      <div class="block-list">
        <div class="block-list-item">
          {{ Form::open(["url" => URL::to("/lessons/save?l=" . encrypt($lesson->id) )]) }}
          ...
          <div class="row">
            ...
            <div class="form-inline">
              <div class="form-group">
                {{ Form::selectRange("date-day", 1, 31, (int) date("d", strtotime($lesson->date)),["class" => "form-control"]) }}
                {{ Form::selectRange("date-month", 1, 12, (int) date("m", strtotime($lesson->date)), ["class" => "form-control"]) }}
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                {{ Form::label('title', 'Título da aula *') }}
                <span class="help-block text-muted">Escolha um título para sua aula.</span>
                {{ Form::text('title', $lesson->title, ['class' => 'form-control', 'maxlength' => '255', 'required' => true]) }}
              </div>
            </div>
          </div>
