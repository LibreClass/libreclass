...
@parent
	...
	<script src="js/validations/usersLogin.js" type="text/javascript"></script>
@stop
...
<div class="container container-login">
	...
	<img alt="" src="images/logo-libreclass-vertical.png" class="logomarca center-block">
	<br>
	...
	<div class="panel panel-login">
		<div class="panel-body">
			...
			<div id="form-login">
				<div class="row">
					<form action="{{ action('Auth\LoginController@store') }}" method="post" id="loginForm">
						@csrf
						<div class="col-md-12">
				...
				{{-- <div class="row"> --}}
					{{-- <div class="col-md-12 text-center"> --}}
						{{-- <a id="btn-register-facebook" class="btn btn-shadow btn-facebook btn-block-xs" href=""><i class="fa fa-facebook fa-lg"></i>&nbsp;&nbsp;&nbsp;<b>Facebook</b></a> --}}
						{{-- <a id="btn-register-google" class="btn btn-shadow btn-google btn-block-xs" href=""><i class="fa fa-google-plus fa-lg"></i>&nbsp;&nbsp;&nbsp;<b>Google</b></a> --}}
					{{-- </div> --}}
				{{-- </div> --}}
			</div>
			{{-- <br> --}}
...
@include('auth.modal-forgot')
@include('auth.modal-new-account')
