	...
	<div class="container">
		...
		<nav class="menu" role="navigation">
			...
			<div class="menu-logo text-center visible-md visible-lg">
				<img alt="Logomarca Libreclass" src="images/logo-libreclass-vertical.png" class="logomarca">
			</div>
			<div class="menu-list visible-lg visible-md">
				<ul class="list-inline text-right scroll">
					...
					<li>
						...
						<a href="{{ action('Auth\LoginController@index') }}" style="color: #fff" class="btn btn-primary">Login</a>
					</li>
				</ul>
			</div>
...
<nav class="menu-slider visible-sm visible-xs">
	<div class="row">
		<div class="col-xs-12">
			<img alt="Logomarca Libreclass" src="images/logo-libreclass-vertical.png" class="logomarca img-responsive">
		</div>
	</div>
