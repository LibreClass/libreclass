                ...
                <div class="block-list-item">
                    <div class="col-md-12 offer">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <input {{ !strcmp($unit->status, 'E')? "checked" : "" }} class="toggle-btn toggle-event" type="checkbox" data-toggle="toggle" data-on="Bloquear" data-off="Desbloquear" data-size="mini" unit="{{ encrypt($unit->id) }}">
                                &nbsp;&nbsp;
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="list-inline">
                                    ...
                                    <button class="btn btn-default btn-block-xs delete-unit" url='{{ URL::to("/classes/offers/delete-last-unit/".encrypt($offer->id)) }}'>
